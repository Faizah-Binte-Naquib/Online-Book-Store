    ...
    <div class="wrapper">
        ...
        <div id="content">
          ...
          <h1 id='heading'>Add New Book</h1>
           ...
           <div class="container">
             <form class="row" name="addForm" action="php/add.php" onsubmit="return validation()" method="post" enctype="multipart/form-data">
              ...
              <div class="shadow p-3 mb-5 bg-white rounded col-11 col-md-5 leftside">
                  ...
                  <div class="form-group">
                    ...
                    <span id="uploaded_image" style="margin-left:20px ;">
                      <img src="image\bookImage.png" height="150" width="300" class="img-thumbnail" />
                    </span>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-lg" type="text" name="author" placeholder="Enter Author Name" required>
                  </div>

                  <div class="form-group">
                    <label for="">ISBN Number</label>
                    <input class="form-control form-control-lg" type="text" name="isbn" placeholder="Enter ISBN Number" maxlength="13" required>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-lg" type="text" name="edition" placeholder="Enter Book Edition" required>
              ...
              <div class="shadow p-3 mb-5 bg-white rounded col-11 col-md-5 rightside">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control form-control-lg" type="text" name="quantity" placeholder="Enter Book Quantity" required>
                  <div style="font-size: 14px;color: gray;">* Enter numbers only.</div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control form-control-lg" type="text" name="fourmonth" placeholder="Enter Rent Price" required>
                  <div style="font-size: 14px;color: gray;">* Enter numbers only.</div>
                </div>

                <div class="form-group">
                  <label for="">Rent Price (6 Months)</label>
                  <input class="form-control form-control-lg" type="text" name="sixmonth" placeholder="Enter Rent Price" required>
                  <div style="font-size: 14px;color: gray;">* Enter numbers only.</div>
                </div>

                <div class="form-group">
                  <label for="">Book Price</label>
                  <input class="form-control form-control-lg" type="text" name="price" placeholder="Enter Book Price" required>
                  <div style="font-size: 14px;color: gray;">* Enter numbers only.</div>
