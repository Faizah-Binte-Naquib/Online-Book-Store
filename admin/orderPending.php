...
if(isset($_GET['id'])){
  $id = intval($_GET['id']);
  $status = 1;
    $stmt = $conn->prepare("UPDATE buys set Status = ? WHERE Order_ID = ? ;");
    ...
    <div class="wrapper">
        ...
        <div id="content">
          ...
          <div>
            ...
            <h1 id="heading">Pennding Order</h1>

            <div class="search-container">
            <form class="form-inline md-form mr-auto mb-4" action="orderPending.php" method="post">
            ...
            <div class="listTable penddingTable">
...
<script>
  $(document).ready(function(){
    ...
    function load_data(query){
      $.ajax({
        url:"php/fetch_pendingOrder.php",
        method:"POST",
        data:{query:query},
