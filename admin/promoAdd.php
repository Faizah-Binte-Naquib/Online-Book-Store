  ...
  <body>
    <div class="wrapper">
        ...
        <div id="content">
          ...
          <h1 id='heading'>Add New Promotion</h1>

           <div class="container">
             <form class="row" name="addForm" action="php/promoAddPhp.php" method="post" enctype="multipart/form-data">
              ...
              <div class="shadow p-3 mb-5 bg-white rounded col-11 col-md-5 leftside">
                  ...
                  <div class="form-group">
                    <label for="">Promotion Image</label><br>
              ...
              <div class="shadow p-3 mb-5 bg-white rounded col-11 col-md-5 rightside">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control form-control-lg" type="text" name="promoName" placeholder="Enter Name" required>
                </div>

                <div class="form-group">
                  <label for="">Promotion Details</label>
                  <textarea class="form-control" name="promoDetail" placeholder="Enter Details" required rows="3"></textarea>
                </div>

                <div >
                  <button class="btn btn-dark btn-rounded btn-lg " type="submit" name="donePromo">Done</button>
                </div>
      ...
      $(document).ready(function() {
        if (!<?php echo isset($_SESSION['promomessage'])?'true':'false'; ?>) {
          console.log("empty session");
        } else {

          var msg = "<?php echo $_SESSION['promomessage'];?>";
          alert(msg);
        }
      });
