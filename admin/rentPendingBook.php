...
if(!(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)){
  ...
  if(isset($_GET['rentId'])){
    ...
    $stmt->close();
    $conn->close();
  header("Location:rentPendingBook.php");
}
  ...
  <body>
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <h1 id="heading">Pending Rented Books</h1>


        <div class="search-container">
          <form class="form-inline md-form mr-auto mb-4" action="rentPendingBook.php" method="post">
...
<script>
  $(document).ready(function(){
    ...
    function load_data(query){
      $.ajax({
        url:"php/fetch_allPendingRent.php",
        method:"POST",
        data:{query:query},
