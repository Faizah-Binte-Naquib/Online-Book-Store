<?php
  ...
  if(isset($_POST['refresh'])){
    header("Location:rentReturnBook.php");
  }  
?>
  ...
  <body>
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <h1 id="heading">Return Rented Books</h1>


        <div class="search-container">
          <form class="form-inline md-form mr-auto mb-4" action="rentReturnBook.php" method="post">
...
<script>
  $(document).ready(function(){
    ...
    function load_data(query){
      $.ajax({
        url:"php/fetch_allReturnRent.php",
        method:"POST",
        data:{query:query},
