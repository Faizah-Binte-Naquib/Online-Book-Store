    	...
    	<section class="checkout-section spad">
    		<div class="container">
    			<div class="row">
                  ...
                  <?php
								...
								<form class="" action="" method="post">
		    						<input class="site-btn submit-order-btn" style="margin-top:50px;" name="submit" type="submit" value="Place Order"/>
		    				</form>
							<?php }
								else {
									...
									while ($row=mysqli_fetch_array($result)) {
									  ?>
										...
										<div class="col-md-12">
											<h5> <b>Address</b>: <?php echo $row['Customer_address'];?></h5><a href="rent_checkout.php?change=1">change</a>
										</div><?php }?>
										...
										<div class="col-md-6">
											<h5><b>Phone Number</b>: <?php echo $row['Customer_phone'];?></h5><a href="rent_checkout.php?change=2">change</a>
										</div>
										<?php } ?>
										<?php
										...
										<div class="col-md-12">
											...
											}?></h5><a href="rent_checkout.php?change=3">change</a>
										</div>
									<?php } ?>
										<?php
										if(isset($_GET['change']))
                ...
                <h5>Cash on Delivery</h5>
								...
								<?php if(!empty($_SESSION['rent'])){?>
									<a href="rent_checkoutphp.php" class="site-btn submit-order-btn">Place Order</a>
								<?php }?>
                    ...
                    if($_SESSION['rent_month'][$index]==4){
										$price=$row['RentPrice_4'];
                    }
                    else {
                      $price=$row['RentPrice_6'];
                    }
										echo number_format($_SESSION['rent_qty_array'][$index]*$price, 2); ?></p>
    							</li>
								<?php $index ++;} }?>
    						</ul>
								<?php if(isset($_SESSION['rent_total'])){?>
    						<ul class="price-list">
    							<li>Total<span>৳<?php if(isset($_SESSION['rent_total'])){ echo $_SESSION['rent_total'];}?></span></li>
    							<li>Shipping<span>৳30</span></li>
    							<li class="total">Total<span>৳<?php echo $_SESSION['rent_total']+30?></span></li>

									<?php
									$_SESSION['checkout_amount']= $_SESSION['rent_total']+30;
								}else {
